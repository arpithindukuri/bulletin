...
import { Container, Typography, TextField, Button, Box, Select} from "@mui/material"
        ...
        {popupState ? (
              ...
              <div className="overlayBox">
                <div className="noteHeader">
                  ...
                  <TextField  variant="standard" defaultValue={"Note Name..." }></TextField>
      ...
      <Box>
        ...
        <Box className="notesTable">
          ...
          {mockNotes.map((notes) => {
            return (
              <Box className="notesTableRow">
                <NoteRow name={notes.name} date={notes.date} tags={notes.tags} content={notes.content}></NoteRow>
              </Box>
            );
          })}
          <Box className="notesTableRow tableCellsFormatting addNewBox"  >
            <Button variant="text" fullWidth={true} onClick={()=>setPopupState(true)}>
              <Typography>
                + Add New Note
              </Typography>
            </Button>
